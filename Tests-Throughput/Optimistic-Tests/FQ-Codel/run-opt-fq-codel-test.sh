#!/bin/bash
# HINT: This script it the same as run-opt-test.sh, please refer to the FQ-Configuration file for further information
# Input: ./run-opt-fq-codel-test.sh (Duration in s:) 120 (CCA:) bbr
