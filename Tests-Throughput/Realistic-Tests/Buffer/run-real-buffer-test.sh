#!/bin/bash
# HINT: This script it the same as run-real-baseline-test.sh, please refer to the Buffer-Configuration file for further information
# Input: ./run-real-buffer-test.sh (duration in s:) 120 (CCA:) bbr
